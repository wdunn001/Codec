...
This is the move agents have been waiting for, whether the people building them know it or not. Tool calls become free to detect. Cross-vocab handoff becomes free to perform. The orchestrator stops being a translation pipeline and starts being a routing fabric, which is what it should have been all along.
