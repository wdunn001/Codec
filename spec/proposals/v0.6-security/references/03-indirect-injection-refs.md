...
- Multiple Aim Security disclosures against M365 Copilot (2024 to 2025) used PDF or Office-document ingestion as the entry point; see EchoLeak (CVE-2025-32711) under [`04-output-exfiltration-refs.md`](04-output-exfiltration-refs.md) §1.
