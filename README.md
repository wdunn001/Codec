...
- **Pretok program runtime in Python + .NET**: both have `\p{L}` support today. The regex path works fine as-is; porting the program runtime gives ~10 to 30% encode-startup speedup.
