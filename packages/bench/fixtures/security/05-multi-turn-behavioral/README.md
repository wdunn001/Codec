...
These attacks are defined as **conversation traces**, not single-message payloads. Validation requires either a live model run (gated behind `RUN_MODEL_TESTS=1` env var) or a recorded reference output from a chosen model.
