...
exports.TokenizerMapHashMismatchError = exports.TokenizerMapValidationError = exports.MemoryMapCache = void 0;
...
exports.MemoryMapCache = MemoryMapCache;
...
class TokenizerMapValidationError extends Error {
    constructor(message) {
        super(`TokenizerMap validation failed: ${message}`);
        this.name = 'TokenizerMapValidationError';
    }
}
exports.TokenizerMapValidationError = TokenizerMapValidationError;
...
class TokenizerMapHashMismatchError extends Error {
    constructor(expected, actual) {
        super(`TokenizerMap hash mismatch.\n  expected: ${expected}\n  actual:   ${actual}`);
        this.name = 'TokenizerMapHashMismatchError';
    }
}
exports.TokenizerMapHashMismatchError = TokenizerMapHashMismatchError;
